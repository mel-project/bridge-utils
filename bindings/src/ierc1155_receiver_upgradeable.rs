...
pub mod ierc1155_receiver_upgradeable {
    ...
    impl<M> std::fmt::Debug for IERC1155ReceiverUpgradeable<M> {
    ...
    impl<M: ethers::providers::Middleware> IERC1155ReceiverUpgradeable<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(
                address.into(),
                IERC1155RECEIVERUPGRADEABLE_ABI.clone(),
                client,
            )
            .into()
        }
    ...
    pub enum IERC1155ReceiverUpgradeableCalls {
    ...
    impl ethers::core::abi::AbiDecode for IERC1155ReceiverUpgradeableCalls {
        fn decode(
            ...
            {
                return Ok(IERC1155ReceiverUpgradeableCalls::OnERC1155BatchReceived(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC1155ReceiverUpgradeableCalls::OnERC1155Received(decoded));
            }
            if let Ok(decoded) =
                <SupportsInterfaceCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC1155ReceiverUpgradeableCalls::SupportsInterface(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for IERC1155ReceiverUpgradeableCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                IERC1155ReceiverUpgradeableCalls::OnERC1155BatchReceived(element) => {
                    element.encode()
                }
                IERC1155ReceiverUpgradeableCalls::OnERC1155Received(element) => element.encode(),
                IERC1155ReceiverUpgradeableCalls::SupportsInterface(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IERC1155ReceiverUpgradeableCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC1155ReceiverUpgradeableCalls::OnERC1155BatchReceived(element) => element.fmt(f),
                IERC1155ReceiverUpgradeableCalls::OnERC1155Received(element) => element.fmt(f),
                IERC1155ReceiverUpgradeableCalls::SupportsInterface(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<OnERC1155BatchReceivedCall> for IERC1155ReceiverUpgradeableCalls {
        fn from(var: OnERC1155BatchReceivedCall) -> Self {
            IERC1155ReceiverUpgradeableCalls::OnERC1155BatchReceived(var)
        }
    }
    impl ::std::convert::From<OnERC1155ReceivedCall> for IERC1155ReceiverUpgradeableCalls {
        fn from(var: OnERC1155ReceivedCall) -> Self {
            IERC1155ReceiverUpgradeableCalls::OnERC1155Received(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for IERC1155ReceiverUpgradeableCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            IERC1155ReceiverUpgradeableCalls::SupportsInterface(var)
        }
    }
