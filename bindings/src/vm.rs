...
pub mod vm {
    ...
    impl<M: ethers::providers::Middleware + Clone> Vm<M> {
    ...
    impl<M: ethers::providers::Middleware + Clone> From<ethers::contract::Contract<M>> for Vm<M> {
