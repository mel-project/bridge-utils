...
pub mod ierc1155_metadata_uri_upgradeable {
    ...
    #[doc = "IERC1155MetadataURIUpgradeable was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static IERC1155METADATAURIUPGRADEABLE_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    pub struct IERC1155MetadataURIUpgradeable<M: Clone>(ethers::contract::Contract<M>);
    impl<M: Clone> Clone for IERC1155MetadataURIUpgradeable<M> {
        fn clone(&self) -> Self {
            IERC1155MetadataURIUpgradeable(self.0.clone())
        }
    }
    impl<M: Clone> std::ops::Deref for IERC1155MetadataURIUpgradeable<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware + Clone> std::fmt::Debug for IERC1155MetadataURIUpgradeable<M> {
        fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
            f.debug_tuple(stringify!(IERC1155MetadataURIUpgradeable))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ethers::providers::Middleware + Clone> IERC1155MetadataURIUpgradeable<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(
                address.into(),
                IERC1155METADATAURIUPGRADEABLE_ABI.clone(),
                client,
            )
            .into()
        }
        ...
        pub fn events(
            &self,
        ) -> ethers::contract::builders::Event<M, IERC1155MetadataURIUpgradeableEvents> {
            self.0.event_with_filter(Default::default())
        }
    }
    impl<M: ethers::providers::Middleware + Clone> From<ethers::contract::Contract<M>>
        for IERC1155MetadataURIUpgradeable<M>
    {
    ...
    pub enum IERC1155MetadataURIUpgradeableEvents {
    ...
    impl ethers::contract::EthLogDecode for IERC1155MetadataURIUpgradeableEvents {
            ...
            Self: Sized,
        {
            if let Ok(decoded) = ApprovalForAllFilter::decode_log(log) {
                return Ok(IERC1155MetadataURIUpgradeableEvents::ApprovalForAllFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = TransferBatchFilter::decode_log(log) {
                return Ok(IERC1155MetadataURIUpgradeableEvents::TransferBatchFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = TransferSingleFilter::decode_log(log) {
                return Ok(IERC1155MetadataURIUpgradeableEvents::TransferSingleFilter(
                    decoded,
                ));
            }
            if let Ok(decoded) = UriFilter::decode_log(log) {
                return Ok(IERC1155MetadataURIUpgradeableEvents::UriFilter(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::std::fmt::Display for IERC1155MetadataURIUpgradeableEvents {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC1155MetadataURIUpgradeableEvents::ApprovalForAllFilter(element) => {
                    element.fmt(f)
                }
                IERC1155MetadataURIUpgradeableEvents::TransferBatchFilter(element) => {
                    element.fmt(f)
                }
                IERC1155MetadataURIUpgradeableEvents::TransferSingleFilter(element) => {
                    element.fmt(f)
                }
                IERC1155MetadataURIUpgradeableEvents::UriFilter(element) => element.fmt(f),
            }
        }
    }
    ...
    #[derive(Debug, Clone, PartialEq, Eq, ethers :: contract :: EthAbiType)]
    pub enum IERC1155MetadataURIUpgradeableCalls {
    ...
    impl ethers::core::abi::AbiDecode for IERC1155MetadataURIUpgradeableCalls {
        fn decode(
            ...
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::BalanceOf(decoded));
            }
            if let Ok(decoded) =
                <BalanceOfBatchCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::BalanceOfBatch(decoded));
            }
            if let Ok(decoded) =
                <IsApprovedForAllCall as ethers::core::abi::AbiDecode>::decode(data.as_ref())
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::IsApprovedForAll(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::SafeBatchTransferFrom(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::SafeTransferFrom(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::SetApprovalForAll(
                    decoded,
                ));
            }
            if let Ok(decoded) =
            ...
            {
                return Ok(IERC1155MetadataURIUpgradeableCalls::SupportsInterface(
                    decoded,
                ));
            }
            if let Ok(decoded) = <UriCall as ethers::core::abi::AbiDecode>::decode(data.as_ref()) {
                return Ok(IERC1155MetadataURIUpgradeableCalls::Uri(decoded));
            }
            Err(ethers::core::abi::Error::InvalidData.into())
        }
    }
    impl ethers::core::abi::AbiEncode for IERC1155MetadataURIUpgradeableCalls {
        fn encode(self) -> Vec<u8> {
            match self {
                IERC1155MetadataURIUpgradeableCalls::BalanceOf(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::BalanceOfBatch(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::IsApprovedForAll(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::SafeBatchTransferFrom(element) => {
                    element.encode()
                }
                IERC1155MetadataURIUpgradeableCalls::SafeTransferFrom(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::SetApprovalForAll(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::SupportsInterface(element) => element.encode(),
                IERC1155MetadataURIUpgradeableCalls::Uri(element) => element.encode(),
            }
        }
    }
    impl ::std::fmt::Display for IERC1155MetadataURIUpgradeableCalls {
        fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
            match self {
                IERC1155MetadataURIUpgradeableCalls::BalanceOf(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::BalanceOfBatch(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::IsApprovedForAll(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::SafeBatchTransferFrom(element) => {
                    element.fmt(f)
                }
                IERC1155MetadataURIUpgradeableCalls::SafeTransferFrom(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::SetApprovalForAll(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::SupportsInterface(element) => element.fmt(f),
                IERC1155MetadataURIUpgradeableCalls::Uri(element) => element.fmt(f),
            }
        }
    }
    impl ::std::convert::From<BalanceOfCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: BalanceOfCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::BalanceOf(var)
        }
    }
    impl ::std::convert::From<BalanceOfBatchCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: BalanceOfBatchCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::BalanceOfBatch(var)
        }
    }
    impl ::std::convert::From<IsApprovedForAllCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: IsApprovedForAllCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::IsApprovedForAll(var)
        }
    }
    impl ::std::convert::From<SafeBatchTransferFromCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: SafeBatchTransferFromCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::SafeBatchTransferFrom(var)
        }
    }
    impl ::std::convert::From<SafeTransferFromCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: SafeTransferFromCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::SafeTransferFrom(var)
        }
    }
    impl ::std::convert::From<SetApprovalForAllCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: SetApprovalForAllCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::SetApprovalForAll(var)
        }
    }
    impl ::std::convert::From<SupportsInterfaceCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: SupportsInterfaceCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::SupportsInterface(var)
        }
    }
    impl ::std::convert::From<UriCall> for IERC1155MetadataURIUpgradeableCalls {
        fn from(var: UriCall) -> Self {
            IERC1155MetadataURIUpgradeableCalls::Uri(var)
        }
    }
