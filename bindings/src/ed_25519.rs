...
mod ed25519_mod {
    ...
    pub static ED25519_BYTECODE: ethers::contract::Lazy<ethers::core::types::Bytes> =
        ethers::contract::Lazy::new(|| {
            "" . parse () . expect ("invalid bytecode")
        });
    #[derive(Clone)]
    ...
    impl<M: ethers::providers::Middleware> std::fmt::Debug for Ed25519<M> {
    ...
    impl<'a, M: ethers::providers::Middleware> Ed25519<M> {
