...
pub mod storage_slot {
    ...
    pub struct StorageSlot<M: Clone>(ethers::contract::Contract<M>);
    impl<M: Clone> Clone for StorageSlot<M> {
        fn clone(&self) -> Self {
            StorageSlot(self.0.clone())
        }
    }
    impl<M: Clone> std::ops::Deref for StorageSlot<M> {
        type Target = ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M: ethers::providers::Middleware + Clone> std::fmt::Debug for StorageSlot<M> {
    ...
    impl<M: ethers::providers::Middleware + Clone> StorageSlot<M> {
    ...
    impl<M: ethers::providers::Middleware + Clone> From<ethers::contract::Contract<M>> for StorageSlot<M> {
