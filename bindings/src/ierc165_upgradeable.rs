pub use ierc165upgradeable_mod::*;
#[allow(clippy::too_many_arguments, non_camel_case_types)]
pub mod ierc165upgradeable_mod {
    ...
    #[doc = "IERC165Upgradeable was auto-generated with ethers-rs Abigen. More information at: https://github.com/gakonst/ethers-rs"]
    use std::sync::Arc;
    pub static IERC165UPGRADEABLE_ABI: ethers::contract::Lazy<ethers::core::abi::Abi> =
    ...
    impl<M: ethers::providers::Middleware> IERC165Upgradeable<M> {
        ...
        pub fn new<T: Into<ethers::core::types::Address>>(
            ...
            ethers::contract::Contract::new(address.into(), IERC165UPGRADEABLE_ABI.clone(), client)
                .into()
        }
